...
Version is read from `packaging/version.txt` (currently **1.3.1**) and passed to Inno Setup.
...
| `release\SelectionTranslation-Setup-1.3.1.exe` | Installer (needs Inno Setup 6) |
