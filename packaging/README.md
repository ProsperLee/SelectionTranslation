...
Version is read from `packaging/version.txt` (currently **1.1.0**) and passed to Inno Setup.
...
| `release\SelectionTranslation-Setup-1.1.0.exe` | Installer (needs Inno Setup 6) |
