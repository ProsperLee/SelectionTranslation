...
import { chevronDoubleRight, iconElement, lockIcon, uploadIcon } from "./icons";
...
export class DiffView {
  ...
  public onSideUpload?: (side: "left" | "right") => void;
  ...
  private build(): void {
    ...
    const leftBody = this.addPane(grid, 1, payload.leftLabel, true, "left");
  ...
  private addPane(
    ...
    if (uploadSide) {
      ...
      uploadBtn.title = uploadSide === "left" ? "上传左侧文件" : "上传右侧文件";
